...
public class BukkitBridge {
    ...
    private void handlePluginMessage(Player player, Server server, DataInput input) throws IOException {
        PlayerConnectionInfo connectionInfo = playerPlayerConnectionInfoMap.get(player);
