...
public abstract class AbstractCustomTablist implements CustomTablist {
    ...
    @Override
    @Nonnull
    public codecrafter47.bungeetablistplus.api.velocity.Icon getIcon(int row, int column) {
    ...
    @Override
    public synchronized void setSlot(int row, int column, @Nonnull @NonNull codecrafter47.bungeetablistplus.api.velocity.Icon icon, @Nonnull @NonNull String text, int ping) {
