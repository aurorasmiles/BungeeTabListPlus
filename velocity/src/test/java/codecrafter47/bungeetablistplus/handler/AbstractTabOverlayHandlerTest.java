    ...
    public void testSimpleTabList() {
        ...
        for (int size = 1; size <= 80; size++) {
            ...
            for (int i = 0; i < size; i++) {
                assertArrayEquals("Skin check failed for size " + size + " slot " + i, codecrafter47.bungeetablistplus.api.velocity.Icon.DEFAULT.getProperties(), clientTabList.getProperties(i));
